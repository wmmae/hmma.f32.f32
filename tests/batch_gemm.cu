...
int main() {
	//test<64, 64, 64, 16, 16, 32, 256>(1024, 1024, 1024, 1024);
	//test<64, 64, 64, 16, 16, 64, 256>(1024, 1024, 1024, 1024);
	//test<64, 64, 128, 16, 16, 32, 256>(1024, 1024, 1024, 1024);
	test<64, 64, 128, 16, 16, 16, 256>(1024, 1024, 1024, 512);
}
