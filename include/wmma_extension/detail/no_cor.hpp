...
template <class Use, int m, int n, int k, class T, class Layout, class Op, int fm, int fn, int fk>
__device__ void load_matrix_sync(fragment<Use, m, n, k, T, Layout, mtk::wmma::mma_f32::Policy<Op, mtk::wmma::mma_f32::op_without_error_correction, fm, fn, fk>>& frag,
...
template <class Use, int m, int n, int k, class T, class Layout, class Op, int fm, int fn, int fk>
__device__ void load_vector(fragment<Use, m, n, k, T, Layout, mtk::wmma::mma_f32::Policy<Op, mtk::wmma::mma_f32::op_without_error_correction, fm, fn, fk>>& frag,
